...
export function getSemesterName(code: number): { semester: string, year: number } {
...
export const calculateNextSemesterResult = (
    ...
    const nextSemesterGPA = nextSemesterTotalGradePoints / nextSemesterTotalCredits;
  
    // Calculate next semester's CGPA
    // const nextSemesterCreditsAttemped = totalEarnedCredits + nextSemesterTotalCredits;
    const nextSemesterCreditsEarned = totalEarnedCredits + nextSemesterTotalCredits;
    const nextSemesterCGPA = (currentCGPA * totalEarnedCredits + nextSemesterTotalGradePoints) / nextSemesterCreditsEarned;
